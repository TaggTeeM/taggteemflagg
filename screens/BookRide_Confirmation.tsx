...
type BookRidePickupScreenRouteProp = RouteProp<RootStackParamList, 'RideDetail'>;
type BookRidePickupScreenNavigationProp = StackNavigationProp<RootStackParamList, 'BookRide'>;
